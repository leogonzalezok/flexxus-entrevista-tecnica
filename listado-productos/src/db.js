export const stock = [
  ...
  {
    id: 1,
    nombre: 'AURICULAR KLIP XTREME OBSESSION BLACK',
  ...
  { 
    id: 2,
    nombre: 'NOTEBOOK ASUS X515MA INTEL CELERON N4020 8GB 240GB 15.6 FREE',
  ...
  {
    id: 3,
    nombre: 'TABLET POSITIVO BGH W750 7" 1GB 8GB ANDROID 7.1',
  ...
  {
    id: 4,
    nombre: 'MONITOR 24 LED SAMSUNG G50 CURVO 144HZ LC24RG50FQL',
  ...
  {
    id: 5,
    nombre: 'STREAM DECK ELGATO 6 BOTONES LCD CUSTOMIZABLE',
  ...
  {
    id: 6,
    nombre: 'ROUTER NETIS W1 300MBPS',
    desc: 'El enrutador netis W1 ofrece 300Mbps de alta velocidad para conectar sus computadoras, teléfonos inteligentes, cámaras inalámbricas y otros dispositivos Wi-Fi. Junto con dos antenas de alta ganancia de 5dBi, garantiza una mejor cobertura inalámbrica y le permite disfrutar de la libertad inalámbrica en cualquier lugar de su hogar, ideal para descargas más rápidas, llamadas por Internet y transmisión de video HD.',
    precio: 1490,
    img: 'https://www.venex.com.ar/products_images/1630426980_w12.jpg',
    stock: 5
  },

  {
    id: 7,
    nombre: 'NOTEBOOK BANGHO MAX L4 I1 F CELERON N4020/SSD 120GB 4GB 14 WIN10',
  ...
  {
    id: 8,
    nombre: 'MICROPROCESADOR INTEL CORE I3 9100 COFFEELAKE 4.2GHZ 4/4 6MB LGA1151',
  ...
  { 
    id: 9,
    nombre: 'NOTEBOOK DELL VOSTRO 3500 I3 1115G4 8GB 1TB SSD 240GB 15.6 UBUNTU',
  ...
  {
    id: 10,
    nombre: 'GAMING KIT HYPERX PULSEFIRE & ALLOY CORE RGB',
  ...
  {
    id: 11,
    nombre: 'AURICULAR HYPERX CLOUD CORE PC 7.1',
  ...
  {
    id: 12,
    nombre: 'MICROFONO HYPERX GAMING SOLOCAST NEGRO PC/MAC/PS4',
  ...
  {
    id: 13,
    nombre: 'AURICULAR INALAMBRICO HYPERX CLOUD STINGER CORE WHITE PC/PS4',
    desc: 'Libertad inalámbrica a un precio increíble. Los auriculares inalámbricos HyperX Cloud Stinger™ Core son ligeros, duraderos y aptos para jugar en sistemas PS4. Chatea con tus amigos online y disfruta de una comunicación nítida con tu equipo gracias al micrófono con cancelación de ruido. Sumérgete en el juego y déjate llevar por el audio gracias a la calidad del sonido de los Cloud Stinger Core. Además, incluye controles de audio integrados en los cascos y un práctico micrófono que se silencia con un simple giro.',
    precio: 7999,
  ...
  {
    id: 14,
    nombre: 'PLACA DE VIDEO MSI NVIDIA GTX 1050TI GAMING X 4GB DDR5',
    desc: '-Funcion de salida de video-DisplayPort x 1 - HDMI x 1 - Doble enlace DVI-D x 1',
    precio: 49999,
    img: 'https://www.venex.com.ar/products_images/1516717296_vg1050.jpg',
    stock: 50
  }
